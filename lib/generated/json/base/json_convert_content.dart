...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case UserEntity:
			return userEntityFromJson(data as UserEntity, json) as T;			case ConfigEntity:
			...
			return configLoginFromJson(data as ConfigLogin, json) as T;			case OAuthEntityEntity:
			return oAuthEntityEntityFromJson(data as OAuthEntityEntity, json) as T;			case UserPreferenceEntity:
			return userPreferenceEntityFromJson(data as UserPreferenceEntity, json) as T;			case OpportunityEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case UserEntity:
			return userEntityToJson(data as UserEntity);			case ConfigEntity:
			...
			return configLoginToJson(data as ConfigLogin);			case OAuthEntityEntity:
			return oAuthEntityEntityToJson(data as OAuthEntityEntity);			case UserPreferenceEntity:
			return userPreferenceEntityToJson(data as UserPreferenceEntity);			case OpportunityEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'UserEntity':
			return UserEntity().fromJson(json);			case 'ConfigEntity':
			return ConfigEntity().fromJson(json);			case 'ConfigFlurry':
			return ConfigFlurry().fromJson(json);			case 'ConfigLogin':
			return ConfigLogin().fromJson(json);			case 'OAuthEntityEntity':
			return OAuthEntityEntity().fromJson(json);			case 'UserPreferenceEntity':
			return UserPreferenceEntity().fromJson(json);			case 'OpportunityEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'UserEntity':
			return List<UserEntity>();			case 'ConfigEntity':
			return List<ConfigEntity>();			case 'ConfigFlurry':
			return List<ConfigFlurry>();			case 'ConfigLogin':
			return List<ConfigLogin>();			case 'OAuthEntityEntity':
			return List<OAuthEntityEntity>();			case 'UserPreferenceEntity':
			return List<UserPreferenceEntity>();			case 'OpportunityEntity':
