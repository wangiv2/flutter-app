...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case UserEntity:
			...
			return oAuthEntityFromJson(data as OAuthEntity, json) as T;			case UserPreferenceEntity:
			return userPreferenceEntityFromJson(data as UserPreferenceEntity, json) as T;			case VersionEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case UserEntity:
			...
			return oAuthEntityToJson(data as OAuthEntity);			case UserPreferenceEntity:
			return userPreferenceEntityToJson(data as UserPreferenceEntity);			case VersionEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'UserEntity':
			...
			return OAuthEntity().fromJson(json);			case 'UserPreferenceEntity':
			return UserPreferenceEntity().fromJson(json);			case 'VersionEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'UserEntity':
			...
			return List<OAuthEntity>();			case 'UserPreferenceEntity':
			return List<UserPreferenceEntity>();			case 'VersionEntity':
