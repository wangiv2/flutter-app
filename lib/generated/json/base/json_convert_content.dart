...
class JsonConvert<T> {
    ...
    switch (type) {			case UserEntity:
			return userEntityFromJson(data as UserEntity, json) as T;			case OAuthEntityEntity:
    ...
    return data as T;
		...
		switch (type) {			case UserEntity:
			return userEntityToJson(data as UserEntity);			case OAuthEntityEntity:
    ...
    switch (T.toString()) {			case 'UserEntity':
			return UserEntity().fromJson(json) as T;			case 'OAuthEntityEntity':
